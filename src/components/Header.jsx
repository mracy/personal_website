      ...
      <div className="flex flex-row justify-between items-center">
        ...
        <div className="flex items-center">
          <button
            ...
            className={`px-4 py-2 sm:px-5 sm:py-3 md:px-6 md:py-3 bg-orange-500 shadow rounded-full text-sm sm:text-base md:text-lg text-white hover:bg-orange-600 hover:text-white transition duration-300 ${isSmallScreen ? 'text-base px-5 py-3' : 'max-w-xs'}`}
          >
            Download CV
          </button>
        </div>
